...
(function(window, document) {
  ...
  ModernWeb = (function() {
    ...
    buildBanner = function() {
      ...
      cssStyle = "#ModernWeb-wrapper{width:100%;height:25%;min-height:250px;" + "display:none;position:absolute;top:0;left:0;z-index:999999;" + "font-family:'Verdana','Helvetica','sans-serif';background-color:#FFF;}" + ".ModernWeb-link{text-decoration:underline;color:#0066FF;}" + "#ModernWeb-h1{margin:20px;font-size:1.2em;color:#333;}" + "#ModernWeb-p{margin:20px;font-size:1em;color:#333;}" + "#ModernWeb-browsers{width:632px;margin:25px auto;}" + ".ModernWeb-noborder{border:0;}" + "#ModernWeb-ietext{font-size:1em;text-align:center;}" + "#ModernWeb-close{position:absolute;top:20px;right:20px;}" + "#ModernWeb-wrapper hr{width:100%;border:2px solid #0066FF;}";
